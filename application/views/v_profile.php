                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" style="width: 18rem;">
                            ...
                            <div class="card-body border-top border-dark">
                                <p class="text-center"><i class="fas fa-user-circle fa-8x"></i></p>
                                <h5 class="card-title text-center"><?php echo $d->nama?></h5>
                                <hr>
                                <p class="lead text-primary text-center"><?php echo $d->divisi?></p>
                                <hr>
                                <p class="lead text-primary text-center"><?php echo $d->alamat?></p>
                                <hr>
                                <?php } ?>
                            </div>
                        </div>
