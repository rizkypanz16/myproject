            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="px-4">
                            <p class="h4">Daftar Proyek</p>
                        </div>
                        <!-- CARD -->
                        <div class="row">
                            <div class="text-right">
                                <a href="<?= base_url('proyek/add') ?>" class="btn btn-sm btn-primary btn-icon-split">
                                    <span class="icon">
                                ...
                                <table class="table table-striped w-100 dt-responsive nowrap" id="dataTable">
                                    ...
                                    <?php
                                        ...
                                        <tr style="font-size: 13px;">
                                            <td><?php echo $no++ ?></td>
                                            <td><strong><?= $s->proyek ?></strong><hr><?= "Instansi : ". $s->instansi ?></td>
                                            <td><?= "Tgl. Mulai : ". $s->mulai_proyek ?><br><?= "Tgl. Selesai : ". $s->selesai_proyek ?></td>
                                            <td>
                                                <a href="<?= base_url().'proyek/addUserproyek/'.$s->id_proyek ?>" class="btn btn-xs btn-success"><i class="fas fa-users"></i></a>
                                            </td>
                                            <td>
                                            <a href='http://localhost/project/proyek/hapus/<?=$s->id_proyek ?>' class="btn btn-xs btn-danger" onclick="return confirm('Apakah Anda benar-benar mau menghapusnya ?')"><i class="fas fa-trash"></i></a>
                                                <!-- <?php echo anchor('proyek/hapus/'.$s->id_proyek, '<i class="fas fa-user-times"></i>');?> -->
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
