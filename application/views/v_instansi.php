            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="px-4">
                            <p class="h4">Daftar Instansi</p>
                        </div>
                        <!-- CARD -->
                        <div class="row">
                            <div class="text-right">
                                <a href="<?= base_url('instansi/add') ?>" class="btn btn-sm btn-primary btn-icon-split">
                                    <span class="icon">
                                ...
                                <table class="table table-striped w-100 dt-responsive nowrap" id="dataTable">
                                    ...
                                    <?php
                                        ...
                                        <tr style="font-size: 13px;">
                                            ...
                                            <td>
                                                <a href='http://localhost/project/instansi/hapus/<?=$s->id_instansi ?>' class="btn btn-xs btn-danger" onclick="return confirm('Apakah Anda benar-benar mau menghapusnya ?')"><i class="fas fa-trash"></i></a>
                                                <!-- <?php echo anchor('instansi/hapus/'.$s->id_instansi, '<i class="fas fa-user-times"></i>');?> -->
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
